...
class MCPServer:
    ...
    def __init__(self):
        ...
        self.tools: dict[str, BaseUserServiceTool] = {}
    ...
    def _register_tools(self):
        ...
        tools_list: list[BaseUserServiceTool] = [
    ...
    def handle_initialize(self, request: MCPRequest) -> tuple[MCPResponse, str]:
        ...
        if request.params and "protocolVersion" in request.params:
            protocol_version = self._validate_protocol_version(request.params["protocolVersion"])
